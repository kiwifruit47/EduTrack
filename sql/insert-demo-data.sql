...
-- -------------------------------------------------------------
-- 10. SCHEDULES  (SchoolId, ClassId, SubjectId, TeacherId, Term, DayOfWeek)
--     DayOfWeek: 1=Mon  2=Tue  3=Wed  4=Thu  5=Fri
-- -------------------------------------------------------------
INSERT INTO Schedules (Id, SchoolId, ClassId, SubjectId, TeacherId, Term, DayOfWeek) VALUES
    -- School 1 — 10А
    (1,  1, 1, 1, 5, 1, 1),   -- Математика    / Стефан      / Mon
    (2,  1, 1, 2, 5, 1, 2),   -- Физика        / Стефан      / Tue
    (3,  1, 1, 3, 6, 1, 3),   -- Български     / Елена       / Wed

    -- School 1 — 11Б
    (4,  1, 2, 1, 5, 1, 1),   -- Математика    / Стефан      / Mon
    (5,  1, 2, 3, 6, 1, 3),   -- Български     / Елена       / Wed

    -- School 2 — 9А
    (6,  2, 3, 1, 8, 1, 1),   -- Математика    / Христо      / Mon
    (7,  2, 3, 4, 7, 1, 2),   -- История       / Теодора     / Tue

    -- School 2 — 10А
    (8,  2, 4, 1, 8,  1, 1),  -- Математика    / Христо      / Mon
    (9,  2, 4, 6, 8,  1, 2),  -- Химия         / Христо      / Tue
    (10, 2, 4, 5, 7,  1, 3),  -- География     / Теодора     / Wed

    -- School 3 — 8В
    (11, 3, 5, 1, 23, 1, 1),  -- Математика    / Ростислав   / Mon
    (12, 3, 5, 7, 24, 1, 2),  -- Биология      / Надежда     / Tue

    -- School 3 — 9Б
    (13, 3, 6, 1, 23, 1, 1),  -- Математика    / Ростислав   / Mon
    (14, 3, 6, 6, 24, 1, 2),  -- Химия         / Надежда     / Tue

    -- School 4 — 10В
    (15, 4, 7, 4, 25, 1, 1),  -- История       / Светлана    / Mon
    (16, 4, 7, 8, 25, 1, 2),  -- Английски     / Светлана    / Tue
    (17, 4, 7, 1, 26, 1, 3),  -- Математика    / Бояна       / Wed

    -- School 4 — 11А
    (18, 4, 8, 8, 25, 1, 1),  -- Английски     / Светлана    / Mon
    (19, 4, 8, 1, 26, 1, 2),  -- Математика    / Бояна       / Tue
    (20, 4, 8, 2, 26, 1, 3),  -- Физика        / Бояна       / Wed

    -- ── Fill all 8 target subjects in every class ─────────────────────

    -- School 1 — 10А  (already has Math/Mon, Physics/Tue, Bulgarian/Wed)
    (21, 1, 1,  8,  6, 1, 4),  -- Английски         / Елена       / Thu
    (22, 1, 1,  9,  6, 1, 5),  -- Музика            / Елена       / Fri
    (23, 1, 1,  6,  5, 1, 1),  -- Химия             / Стефан      / Mon
    (24, 1, 1,  10, 6, 1, 2),  -- Физ. възпитание   / Елена       / Tue
    (25, 1, 1,  11, 5, 1, 3),  -- ИТ                / Стефан      / Wed

    -- School 1 — 11Б  (already has Math/Mon, Bulgarian/Wed)
    (26, 1, 2,  2,  5, 1, 2),  -- Физика            / Стефан      / Tue
    (27, 1, 2,  8,  6, 1, 4),  -- Английски         / Елена       / Thu
    (28, 1, 2,  9,  6, 1, 5),  -- Музика            / Елена       / Fri
    (29, 1, 2,  6,  5, 1, 1),  -- Химия             / Стефан      / Mon
    (30, 1, 2,  10, 6, 1, 2),  -- Физ. възпитание   / Елена       / Tue
    (31, 1, 2,  11, 5, 1, 4),  -- ИТ                / Стефан      / Thu

    -- School 2 — 9А   (already has Math/Mon, History/Tue)
    (32, 2, 3,  3,  7, 1, 3),  -- Български         / Теодора     / Wed
    (33, 2, 3,  8,  7, 1, 4),  -- Английски         / Теодора     / Thu
    (34, 2, 3,  2,  8, 1, 1),  -- Физика            / Христо      / Mon
    (35, 2, 3,  9,  7, 1, 5),  -- Музика            / Теодора     / Fri
    (36, 2, 3,  6,  8, 1, 2),  -- Химия             / Христо      / Tue
    (37, 2, 3,  10, 7, 1, 3),  -- Физ. възпитание   / Теодора     / Wed
    (38, 2, 3,  11, 8, 1, 4),  -- ИТ                / Христо      / Thu

    -- School 2 — 10А  (already has Math/Mon, Chemistry/Tue, Geography/Wed)
    (39, 2, 4,  3,  7, 1, 4),  -- Български         / Теодора     / Thu
    (40, 2, 4,  8,  7, 1, 5),  -- Английски         / Теодора     / Fri
    (41, 2, 4,  2,  8, 1, 1),  -- Физика            / Христо      / Mon
    (42, 2, 4,  9,  7, 1, 2),  -- Музика            / Теодора     / Tue
    (43, 2, 4,  10, 7, 1, 3),  -- Физ. възпитание   / Теодора     / Wed
    (44, 2, 4,  11, 8, 1, 4),  -- ИТ                / Христо      / Thu

    -- School 3 — 8В   (already has Math/Mon, Biology/Tue)
    (45, 3, 5,  3,  24, 1, 3), -- Български         / Надежда     / Wed
    (46, 3, 5,  8,  24, 1, 4), -- Английски         / Надежда     / Thu
    (47, 3, 5,  2,  23, 1, 1), -- Физика            / Ростислав   / Mon
    (48, 3, 5,  9,  24, 1, 5), -- Музика            / Надежда     / Fri
    (49, 3, 5,  6,  24, 1, 2), -- Химия             / Надежда     / Tue
    (50, 3, 5,  10, 24, 1, 3), -- Физ. възпитание   / Надежда     / Wed
    (51, 3, 5,  11, 23, 1, 4), -- ИТ                / Ростислав   / Thu

    -- School 3 — 9Б   (already has Math/Mon, Chemistry/Tue)
    (52, 3, 6,  3,  24, 1, 3), -- Български         / Надежда     / Wed
    (53, 3, 6,  8,  24, 1, 4), -- Английски         / Надежда     / Thu
    (54, 3, 6,  2,  23, 1, 1), -- Физика            / Ростислав   / Mon
    (55, 3, 6,  9,  24, 1, 5), -- Музика            / Надежда     / Fri
    (56, 3, 6,  10, 24, 1, 3), -- Физ. възпитание   / Надежда     / Wed
    (57, 3, 6,  11, 23, 1, 4), -- ИТ                / Ростислав   / Thu

    -- School 4 — 10В  (already has History/Mon, English/Tue, Math/Wed)
    (58, 4, 7,  3,  25, 1, 4), -- Български         / Светлана    / Thu
    (59, 4, 7,  2,  26, 1, 1), -- Физика            / Бояна       / Mon
    (60, 4, 7,  9,  25, 1, 5), -- Музика            / Светлана    / Fri
    (61, 4, 7,  6,  26, 1, 2), -- Химия             / Бояна       / Tue
    (62, 4, 7,  10, 25, 1, 3), -- Физ. възпитание   / Светлана    / Wed
    (63, 4, 7,  11, 26, 1, 4), -- ИТ                / Бояна       / Thu

    -- School 4 — 11А  (already has English/Mon, Math/Tue, Physics/Wed)
    (64, 4, 8,  3,  25, 1, 4), -- Български         / Светлана    / Thu
    (65, 4, 8,  9,  25, 1, 1), -- Музика            / Светлана    / Mon
    (66, 4, 8,  6,  26, 1, 5), -- Химия             / Бояна       / Fri
    (67, 4, 8,  10, 25, 1, 2), -- Физ. възпитание   / Светлана    / Tue
    (68, 4, 8,  11, 26, 1, 3); -- ИТ                / Бояна       / Wed
