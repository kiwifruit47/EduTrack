...
-- 5. TEACHERS
-- -------------------------------------------------------------
INSERT INTO Teachers (UserId, SchoolId, Salary) VALUES
    (5,  1, 2150.00),  -- Стефан Димитров  → School 1
    (6,  1, 1980.00),  -- Елена Иванова    → School 1
    (7,  2, 2300.00),  -- Теодора Стоянова → School 2
    (8,  2, 2050.00),  -- Христо Христов   → School 2
    (23, 3, 1850.00),  -- Ростислав Петков → School 3
    (24, 3, 1920.00),  -- Надежда Стоилова → School 3
    (25, 4, 2200.00),  -- Светлана Колева  → School 4
    (26, 4, 2075.00);  -- Бояна Попова     → School 4


-- -------------------------------------------------------------
-- 6. STUDENTS
-- -------------------------------------------------------------
INSERT INTO Students (UserId, SchoolId, ClassId, ParentId) VALUES
    (9,  1, 1, 17),   -- Ангел      → School 1, 10А, parent: Надя
    (10, 1, 1, 17),   -- Борислава  → School 1, 10А, parent: Надя
    (11, 1, 2, 18),   -- Виктор     → School 1, 11Б, parent: Калоян
    (12, 1, 2, 18),   -- Габриела   → School 1, 11Б, parent: Калоян
    (13, 2, 3, 19),   -- Диана      → School 2, 9А,  parent: Лиляна
    (14, 2, 3, 19),   -- Емил       → School 2, 9А,  parent: Лиляна
    (15, 2, 4, 20),   -- Живко      → School 2, 10А, parent: Методи
    (16, 2, 4, 20),   -- Ивелина    → School 2, 10А, parent: Методи
    (27, 3, 5, 35),   -- Красимир   → School 3, 8В,  parent: Александра
    (28, 3, 5, 35),   -- Маргарита  → School 3, 8В,  parent: Александра
    (29, 3, 6, 36),   -- Николай    → School 3, 9Б,  parent: Борислав
    (30, 3, 6, 36),   -- Петя       → School 3, 9Б,  parent: Борислав
    (31, 4, 7, 37),   -- Радослав   → School 4, 10В, parent: Венелин
    (32, 4, 7, 37),   -- Симона     → School 4, 10В, parent: Венелин
    (33, 4, 8, 38),   -- Тодор      → School 4, 11А, parent: Горан
    (34, 4, 8, 38);   -- Фани       → School 4, 11А, parent: Горан
...
INSERT INTO Teacher_Qualifications (TeacherId, SubjectId) VALUES
    ...
    (6,  8),   -- Елена     → Английски
    (6,  9),   -- Елена     → Музика
    (6,  10),  -- Елена     → Физ. възпитание
    -- School 2
    (7,  3),   -- Теодора   → Български
    (7,  4),   -- Теодора   → История
    (7,  5),   -- Теодора   → География
    (7,  8),   -- Теодора   → Английски
    (7,  9),   -- Теодора   → Музика
    (7,  10),  -- Теодора   → Физ. възпитание
    ...
    (23, 2),   -- Ростислав → Физика
    (23, 7),   -- Ростислав → Биология
    (23, 11),  -- Ростислав → ИТ
    (24, 3),   -- Надежда   → Български
    (24, 6),   -- Надежда   → Химия
    (24, 7),   -- Надежда   → Биология
    (24, 8),   -- Надежда   → Английски
    (24, 9),   -- Надежда   → Музика
    (24, 10),  -- Надежда   → Физ. възпитание
    -- School 4
    (25, 3),   -- Светлана  → Български
    (25, 4),   -- Светлана  → История
    (25, 8),   -- Светлана  → Английски
    (25, 9),   -- Светлана  → Музика
    (25, 10),  -- Светлана  → Физ. възпитание
...
-- -------------------------------------------------------------
-- 10. SCHEDULES  (SchoolId, ClassId, SubjectId, TeacherId, Term, DayOfWeek, StartTime, EndTime)
--     DayOfWeek: 1=Mon  2=Tue  3=Wed  4=Thu  5=Fri
--     Period 1: 08:00–08:40   Period 2: 08:50–09:30
-- -------------------------------------------------------------
INSERT INTO Schedules (Id, SchoolId, ClassId, SubjectId, TeacherId, Term, DayOfWeek, StartTime, EndTime) VALUES
    -- School 1 — 10А
    (1,  1, 1, 1, 5, 1, 1, '08:00', '08:40'),  -- Математика    / Стефан      / Mon P1
    (2,  1, 1, 2, 5, 1, 2, '08:00', '08:40'),  -- Физика        / Стефан      / Tue P1
    (3,  1, 1, 3, 6, 1, 3, '08:00', '08:40'),  -- Български     / Елена       / Wed P1

    -- School 1 — 11Б
    (4,  1, 2, 1, 5, 1, 1, '08:00', '08:40'),  -- Математика    / Стефан      / Mon P1
    (5,  1, 2, 3, 6, 1, 3, '08:00', '08:40'),  -- Български     / Елена       / Wed P1

    -- School 2 — 9А
    (6,  2, 3, 1, 8, 1, 1, '08:00', '08:40'),  -- Математика    / Христо      / Mon P1
    (7,  2, 3, 4, 7, 1, 2, '08:00', '08:40'),  -- История       / Теодора     / Tue P1

    -- School 2 — 10А
    (8,  2, 4, 1, 8,  1, 1, '08:00', '08:40'), -- Математика    / Христо      / Mon P1
    (9,  2, 4, 6, 8,  1, 2, '08:00', '08:40'), -- Химия         / Христо      / Tue P1
    (10, 2, 4, 5, 7,  1, 3, '08:00', '08:40'), -- География     / Теодора     / Wed P1

    -- School 3 — 8В
    (11, 3, 5, 1, 23, 1, 1, '08:00', '08:40'), -- Математика    / Ростислав   / Mon P1
    (12, 3, 5, 7, 24, 1, 2, '08:00', '08:40'), -- Биология      / Надежда     / Tue P1

    -- School 3 — 9Б
    (13, 3, 6, 1, 23, 1, 1, '08:00', '08:40'), -- Математика    / Ростислав   / Mon P1
    (14, 3, 6, 6, 24, 1, 2, '08:00', '08:40'), -- Химия         / Надежда     / Tue P1

    -- School 4 — 10В
    (15, 4, 7, 4, 25, 1, 1, '08:00', '08:40'), -- История       / Светлана    / Mon P1
    (16, 4, 7, 8, 25, 1, 2, '08:00', '08:40'), -- Английски     / Светлана    / Tue P1
    (17, 4, 7, 1, 26, 1, 3, '08:00', '08:40'), -- Математика    / Бояна       / Wed P1

    -- School 4 — 11А
    (18, 4, 8, 8, 25, 1, 1, '08:00', '08:40'), -- Английски     / Светлана    / Mon P1
    (19, 4, 8, 1, 26, 1, 2, '08:00', '08:40'), -- Математика    / Бояна       / Tue P1
    (20, 4, 8, 2, 26, 1, 3, '08:00', '08:40'), -- Физика        / Бояна       / Wed P1

    -- ── Fill all 8 target subjects in every class ─────────────────────

    -- School 1 — 10А  (already has Math/Mon P1, Physics/Tue P1, Bulgarian/Wed P1)
    (21, 1, 1,  8,  6, 1, 4, '08:00', '08:40'), -- Английски         / Елена       / Thu P1
    (22, 1, 1,  9,  6, 1, 5, '08:00', '08:40'), -- Музика            / Елена       / Fri P1
    (23, 1, 1,  6,  5, 1, 1, '08:50', '09:30'), -- Химия             / Стефан      / Mon P2
    (24, 1, 1,  10, 6, 1, 2, '08:50', '09:30'), -- Физ. възпитание   / Елена       / Tue P2
    (25, 1, 1,  11, 5, 1, 3, '08:50', '09:30'), -- ИТ                / Стефан      / Wed P2

    -- School 1 — 11Б  (already has Math/Mon P1, Bulgarian/Wed P1)
    (26, 1, 2,  2,  5, 1, 2, '08:00', '08:40'), -- Физика            / Стефан      / Tue P1
    (27, 1, 2,  8,  6, 1, 4, '08:00', '08:40'), -- Английски         / Елена       / Thu P1
    (28, 1, 2,  9,  6, 1, 5, '08:00', '08:40'), -- Музика            / Елена       / Fri P1
    (29, 1, 2,  6,  5, 1, 1, '08:50', '09:30'), -- Химия             / Стефан      / Mon P2
    (30, 1, 2,  10, 6, 1, 2, '08:50', '09:30'), -- Физ. възпитание   / Елена       / Tue P2
    (31, 1, 2,  11, 5, 1, 4, '08:50', '09:30'), -- ИТ                / Стефан      / Thu P2

    -- School 2 — 9А   (already has Math/Mon P1, History/Tue P1)
    (32, 2, 3,  3,  7, 1, 3, '08:00', '08:40'), -- Български         / Теодора     / Wed P1
    (33, 2, 3,  8,  7, 1, 4, '08:00', '08:40'), -- Английски         / Теодора     / Thu P1
    (34, 2, 3,  2,  8, 1, 1, '08:50', '09:30'), -- Физика            / Христо      / Mon P2
    (35, 2, 3,  9,  7, 1, 5, '08:00', '08:40'), -- Музика            / Теодора     / Fri P1
    (36, 2, 3,  6,  8, 1, 2, '08:50', '09:30'), -- Химия             / Христо      / Tue P2
    (37, 2, 3,  10, 7, 1, 3, '08:50', '09:30'), -- Физ. възпитание   / Теодора     / Wed P2
    (38, 2, 3,  11, 8, 1, 4, '08:50', '09:30'), -- ИТ                / Христо      / Thu P2

    -- School 2 — 10А  (already has Math/Mon P1, Chemistry/Tue P1, Geography/Wed P1)
    (39, 2, 4,  3,  7, 1, 4, '08:00', '08:40'), -- Български         / Теодора     / Thu P1
    (40, 2, 4,  8,  7, 1, 5, '08:00', '08:40'), -- Английски         / Теодора     / Fri P1
    (41, 2, 4,  2,  8, 1, 1, '08:50', '09:30'), -- Физика            / Христо      / Mon P2
    (42, 2, 4,  9,  7, 1, 2, '08:50', '09:30'), -- Музика            / Теодора     / Tue P2
    (43, 2, 4,  10, 7, 1, 3, '08:50', '09:30'), -- Физ. възпитание   / Теодора     / Wed P2
    (44, 2, 4,  11, 8, 1, 4, '08:50', '09:30'), -- ИТ                / Христо      / Thu P2

    -- School 3 — 8В   (already has Math/Mon P1, Biology/Tue P1)
    (45, 3, 5,  3,  24, 1, 3, '08:00', '08:40'), -- Български         / Надежда     / Wed P1
    (46, 3, 5,  8,  24, 1, 4, '08:00', '08:40'), -- Английски         / Надежда     / Thu P1
    (47, 3, 5,  2,  23, 1, 1, '08:50', '09:30'), -- Физика            / Ростислав   / Mon P2
    (48, 3, 5,  9,  24, 1, 5, '08:00', '08:40'), -- Музика            / Надежда     / Fri P1
    (49, 3, 5,  6,  24, 1, 2, '08:50', '09:30'), -- Химия             / Надежда     / Tue P2
    (50, 3, 5,  10, 24, 1, 3, '08:50', '09:30'), -- Физ. възпитание   / Надежда     / Wed P2
    (51, 3, 5,  11, 23, 1, 4, '08:50', '09:30'), -- ИТ                / Ростислав   / Thu P2

    -- School 3 — 9Б   (already has Math/Mon P1, Chemistry/Tue P1)
    (52, 3, 6,  3,  24, 1, 3, '08:00', '08:40'), -- Български         / Надежда     / Wed P1
    (53, 3, 6,  8,  24, 1, 4, '08:00', '08:40'), -- Английски         / Надежда     / Thu P1
    (54, 3, 6,  2,  23, 1, 1, '08:50', '09:30'), -- Физика            / Ростислав   / Mon P2
    (55, 3, 6,  9,  24, 1, 5, '08:00', '08:40'), -- Музика            / Надежда     / Fri P1
    (56, 3, 6,  10, 24, 1, 3, '08:50', '09:30'), -- Физ. възпитание   / Надежда     / Wed P2
    (57, 3, 6,  11, 23, 1, 4, '08:50', '09:30'), -- ИТ                / Ростислав   / Thu P2

    -- School 4 — 10В  (already has History/Mon P1, English/Tue P1, Math/Wed P1)
    (58, 4, 7,  3,  25, 1, 4, '08:00', '08:40'), -- Български         / Светлана    / Thu P1
    (59, 4, 7,  2,  26, 1, 1, '08:50', '09:30'), -- Физика            / Бояна       / Mon P2
    (60, 4, 7,  9,  25, 1, 5, '08:00', '08:40'), -- Музика            / Светлана    / Fri P1
    (61, 4, 7,  6,  26, 1, 2, '08:50', '09:30'), -- Химия             / Бояна       / Tue P2
    (62, 4, 7,  10, 25, 1, 3, '08:50', '09:30'), -- Физ. възпитание   / Светлана    / Wed P2
    (63, 4, 7,  11, 26, 1, 4, '08:50', '09:30'), -- ИТ                / Бояна       / Thu P2

    -- School 4 — 11А  (already has English/Mon P1, Math/Tue P1, Physics/Wed P1)
    (64, 4, 8,  3,  25, 1, 4, '08:00', '08:40'), -- Български         / Светлана    / Thu P1
    (65, 4, 8,  9,  25, 1, 1, '08:50', '09:30'), -- Музика            / Светлана    / Mon P2
    (66, 4, 8,  6,  26, 1, 5, '08:00', '08:40'), -- Химия             / Бояна       / Fri P1
    (67, 4, 8,  10, 25, 1, 2, '08:50', '09:30'), -- Физ. възпитание   / Светлана    / Tue P2
    (68, 4, 8,  11, 26, 1, 3, '08:50', '09:30'); -- ИТ                / Бояна       / Wed P2


-- -------------------------------------------------------------
-- 11. GRADES  (valid values: 2, 2.5, 3, 3.5, 4, 4.5, 5, 5.5, 6)
-- -------------------------------------------------------------
INSERT INTO Grades (StudentId, ScheduleId, Value, CreatedAt) VALUES
    -- Ангел (10А, School 1)
    (9,  1, 5.5, '2024-11-15 09:00:00'),   -- Математика
    (9,  2, 5.0, '2024-11-20 10:00:00'),   -- Физика
    (9,  3, 6.0, '2024-11-25 11:00:00'),   -- Български

    -- Борислава (10А, School 1)
    (10, 1, 3.5, '2024-11-15 09:05:00'),   -- Математика
    (10, 2, 4.0, '2024-11-20 10:05:00'),   -- Физика
    (10, 3, 5.0, '2024-11-25 11:05:00'),   -- Български

    -- Виктор (11Б, School 1)
    (11, 4, 4.5, '2024-11-15 09:00:00'),   -- Математика
    (11, 5, 5.5, '2024-11-22 11:00:00'),   -- Български

    -- Габриела (11Б, School 1)
    (12, 4, 2.5, '2024-11-15 09:05:00'),   -- Математика
    (12, 5, 3.0, '2024-11-22 11:05:00'),   -- Български

    -- Диана (9А, School 2)
    (13, 6, 5.0, '2024-11-18 09:00:00'),   -- Математика
    (13, 7, 4.5, '2024-11-21 10:00:00'),   -- История

    -- Емил (9А, School 2)
    (14, 6, 6.0, '2024-11-18 09:10:00'),   -- Математика
    (14, 7, 5.5, '2024-11-21 10:10:00'),   -- История

    -- Живко (10А, School 2)
    (15, 8, 4.0, '2024-11-19 09:00:00'),   -- Математика
    (15, 9, 4.0, '2024-11-22 10:00:00'),   -- Химия
    (15, 10, 4.0, '2024-11-26 11:00:00'),  -- География

    -- Ивелина (10А, School 2)
    (16, 8,  5.5, '2024-11-19 09:10:00'),  -- Математика
    (16, 9,  5.0, '2024-11-22 10:10:00'),  -- Химия
    (16, 10, 6.0, '2024-11-26 11:10:00'),  -- География

    -- Красимир (8В, School 3)
    (27, 11, 5.0, '2024-11-15 09:00:00'),  -- Математика
    (27, 12, 4.5, '2024-11-20 10:00:00'),  -- Биология

    -- Маргарита (8В, School 3)
    (28, 11, 4.0, '2024-11-15 09:05:00'),  -- Математика
    (28, 12, 5.5, '2024-11-20 10:05:00'),  -- Биология

    -- Николай (9Б, School 3)
    (29, 13, 4.0, '2024-11-17 09:00:00'),  -- Математика
    (29, 14, 4.0, '2024-11-24 10:00:00'),  -- Химия

    -- Петя (9Б, School 3)
    (30, 13, 5.0, '2024-11-17 09:05:00'),  -- Математика
    (30, 14, 5.5, '2024-11-24 10:05:00'),  -- Химия

    -- Радослав (10В, School 4)
    (31, 15, 4.5, '2024-11-18 09:00:00'),  -- История
    (31, 16, 5.0, '2024-11-25 10:00:00'),  -- Английски
    (31, 17, 3.5, '2024-11-28 11:00:00'),  -- Математика

    -- Симона (10В, School 4)
    (32, 15, 5.5, '2024-11-18 09:05:00'),  -- История
    (32, 16, 6.0, '2024-11-25 10:05:00'),  -- Английски
    (32, 17, 5.0, '2024-11-28 11:05:00'),  -- Математика

    -- Тодор (11А, School 4)
    (33, 18, 4.0, '2024-11-19 09:00:00'),  -- Английски
    (33, 19, 2.5, '2024-11-26 10:00:00'),  -- Математика
    (33, 20, 3.5, '2024-11-29 11:00:00'),  -- Физика

    -- Фани (11А, School 4)
    (34, 18, 5.5, '2024-11-19 09:05:00'),  -- Английски
    (34, 19, 5.0, '2024-11-26 10:05:00'),  -- Математика
    (34, 20, 5.0, '2024-11-29 11:05:00');  -- Физика
...
SELECT setval(pg_get_serial_sequence('subjects',  'id'), 11);
SELECT setval(pg_get_serial_sequence('schedules', 'id'), 68);
