...
INSERT INTO Schedules (Id, SchoolId, ClassId, SubjectId, TeacherId, Term) VALUES
    ...
    -- School 1 — 10А  (already has Math, Physics, Bulgarian)
    (21, 1, 1,  8,  6, 1),  -- Английски         / Елена
    (22, 1, 1,  9,  6, 1),  -- Музика            / Елена
    (23, 1, 1,  6,  5, 1),  -- Химия             / Стефан
    (24, 1, 1,  10, 6, 1),  -- Физ. възпитание   / Елена
    (25, 1, 1,  11, 5, 1),  -- ИТ                / Стефан

    -- School 1 — 11Б  (already has Math, Bulgarian)
    (26, 1, 2,  2,  5, 1),  -- Физика            / Стефан
    (27, 1, 2,  8,  6, 1),  -- Английски         / Елена
    (28, 1, 2,  9,  6, 1),  -- Музика            / Елена
    (29, 1, 2,  6,  5, 1),  -- Химия             / Стефан
    (30, 1, 2,  10, 6, 1),  -- Физ. възпитание   / Елена
    (31, 1, 2,  11, 5, 1),  -- ИТ                / Стефан

    -- School 2 — 9А   (already has Math, History)
    (32, 2, 3,  3,  7, 1),  -- Български         / Теодора
    (33, 2, 3,  8,  7, 1),  -- Английски         / Теодора
    (34, 2, 3,  2,  8, 1),  -- Физика            / Христо
    (35, 2, 3,  9,  7, 1),  -- Музика            / Теодора
    (36, 2, 3,  6,  8, 1),  -- Химия             / Христо
    (37, 2, 3,  10, 7, 1),  -- Физ. възпитание   / Теодора
    (38, 2, 3,  11, 8, 1),  -- ИТ                / Христо

    -- School 2 — 10А  (already has Math, Chemistry, Geography)
    (39, 2, 4,  3,  7, 1),  -- Български         / Теодора
    (40, 2, 4,  8,  7, 1),  -- Английски         / Теодора
    (41, 2, 4,  2,  8, 1),  -- Физика            / Христо
    (42, 2, 4,  9,  7, 1),  -- Музика            / Теодора
    (43, 2, 4,  10, 7, 1),  -- Физ. възпитание   / Теодора
    (44, 2, 4,  11, 8, 1),  -- ИТ                / Христо

    -- School 3 — 8В   (already has Math, Biology)
    (45, 3, 5,  3,  24, 1), -- Български         / Надежда
    (46, 3, 5,  8,  24, 1), -- Английски         / Надежда
    (47, 3, 5,  2,  23, 1), -- Физика            / Ростислав
    (48, 3, 5,  9,  24, 1), -- Музика            / Надежда
    (49, 3, 5,  6,  24, 1), -- Химия             / Надежда
    (50, 3, 5,  10, 24, 1), -- Физ. възпитание   / Надежда
    (51, 3, 5,  11, 23, 1), -- ИТ                / Ростислав

    -- School 3 — 9Б   (already has Math, Chemistry)
    (52, 3, 6,  3,  24, 1), -- Български         / Надежда
    (53, 3, 6,  8,  24, 1), -- Английски         / Надежда
    (54, 3, 6,  2,  23, 1), -- Физика            / Ростислав
    (55, 3, 6,  9,  24, 1), -- Музика            / Надежда
    (56, 3, 6,  10, 24, 1), -- Физ. възпитание   / Надежда
    (57, 3, 6,  11, 23, 1), -- ИТ                / Ростислав

    -- School 4 — 10В  (already has History, English, Math)
    (58, 4, 7,  3,  25, 1), -- Български         / Светлана
    (59, 4, 7,  2,  26, 1), -- Физика            / Бояна
    (60, 4, 7,  9,  25, 1), -- Музика            / Светлана
    (61, 4, 7,  6,  26, 1), -- Химия             / Бояна
    (62, 4, 7,  10, 25, 1), -- Физ. възпитание   / Светлана
    (63, 4, 7,  11, 26, 1), -- ИТ                / Бояна

    -- School 4 — 11А  (already has English, Math, Physics)
    (64, 4, 8,  3,  25, 1), -- Български         / Светлана
    (65, 4, 8,  9,  25, 1), -- Музика            / Светлана
    (66, 4, 8,  6,  26, 1), -- Химия             / Бояна
    (67, 4, 8,  10, 25, 1), -- Физ. възпитание   / Светлана
    (68, 4, 8,  11, 26, 1); -- ИТ                / Бояна
